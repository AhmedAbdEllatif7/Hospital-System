                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                        @if(auth()->guard('admin')->user())
                            src="{{URL::asset('attachments/Admins/'.auth()->user()->image->file_name)}}"></a>
                        @elseif(auth()->user())
                        src="{{URL::asset('attachments/Patients/'.auth()->user()->image->file_name)}}"></a>
                        @endif
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                @if(auth()->guard('admin')->user())
                                <div class="main-img-user"><img alt="" src="{{URL::asset('attachments/Admins/'.auth()->user()->image->file_name)}}" class="">
                                    @elseif(auth()->user())
                                        <div class="main-img-user"><img alt="" src="{{URL::asset('attachments/Patients/'.auth()->user()->image->file_name)}}" class="">
                                            @endif
                                        </div>
