                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            <div>
                                @if($doctor->image)
                                    <img style="border-radius:20%"
                                         src="{{Url::asset('attachments/Doctors/'.$doctor->image->file_name)}}"
                                         height="150px" width="150px" alt="">
                                @else
                                    <img style="border-radius:50%"
                                         src="{{Url::asset('attachments/Doctors/default_doctor_photo.jpg')}}"
                                         height="50px"
                                         width="50px" alt="">
                                @endif
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" name="name" value="{{$doctor->name}}" type="text" required>
                                </div>
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" value="{{$doctor->email}}" name="email" type="email" required>
                                </div>
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" value="{{$doctor->password}}" name="password" type="password" required>
                                </div>
                            </div>
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <select multiple="multiple" class="testselect2" name="appointments[]">
                                        @foreach($appointments as $appointment)
                                            <option value="{{$appointment->id}}" {{ $doctor->doctorappointments->contains($appointment) ? 'selected' : '' }}>{{$appointment->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
