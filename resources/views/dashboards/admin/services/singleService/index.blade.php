...
@section('content')
                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example2">
                            ...
                            @foreach($services as $service)
                                ...
                                @include('dashboards.admin.services.singleService.edit')
                                @include('dashboards.admin.services.singleService.delete')
                            @endforeach
                            </tbody>
                        </table>
                    </div>
    ...
    @include('dashboards.admin.services.singleService.create')
    <!-- /row -->
