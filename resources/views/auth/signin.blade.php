@extends('dashboards.layouts.master2')
@section('css')
				...
				<div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
					<div class="row wd-100p mx-auto text-center">
						<div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
							<img src="https://images.pexels.com/photos/8442147/pexels-photo-8442147.jpeg?auto=compress&cs=tinysrgb&w=600" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
						</div>
					</div>
				</div>
				<!-- The content half -->
									...
									<div class="card-sigin">
										...
										<div class="card-sigin">
											<div class="main-signup-header">
                                                ...
                                                <h5 class="font-weight-semibold mb-4">{{trans('Dashboard/login_trans.login_as_a_patient')}}</h5>
                                            ...
                                            <div class="loginform" id="admin">
                                                <h5 class="font-weight-semibold mb-4">{{trans('Dashboard/login_trans.login_as_an_admin')}}</h5>
